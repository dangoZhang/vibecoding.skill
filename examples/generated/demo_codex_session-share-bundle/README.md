...
当前大致处在 `L4`。 你最突出的地方是 prompt 起手很稳。给 AI 下任务前，会先把目标和上下文摆好，让 code agent 一上来就知道先做什么。

具体到执行层，你明显更信证据而不是空讲。凡是能读文件、跑命令、查日志的地方，都会先让 code agent 动手，再根据结果补 prompt。

整体看，你很会驱动 AI 干活，强在先收束任务、上下文给得足、对结果有验收；如果还想把这套 prompt 习惯继续打磨，下一步最该补的是偏了之后的修正速度。
...
- 等级：`L4`
- 判断：你已经能把常见任务沿着上下文稳定推到多步完成，熟悉的问题不太会半路掉线。 这轮最亮眼的是上下文铺垫和执行推进：你这边路径、背景和边界给得够，AI 更容易直接落地，AI 这边能先动手，再汇报，推进感比较强。 眼下最该补的是迭代修正和补救适配：你这边发现偏航后的修正还不够快，容易在错误方向上多走几步，AI 这边遇到阻力后的调整还不够快。
- 取样规模：`2,892 tokens · 4 条消息 · 2 次工具调用`
- 导出时间：`2026-04-14 02:21`
